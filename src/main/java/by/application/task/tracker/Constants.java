...
public class Constants {
    ...
    public static final String USER_NOT_ACTIVATED = "Not activated";
    ...
    public static final String IN_BUILD = "In build";
    ...
    public static final String NEED_INFO = "Additional info required";
    public static final String INFO_RECEIVED = "Info received";
